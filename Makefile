...
pdf: compile build rmPdf geschwisterTag createPdf view
...
build:
	java -jar $$(find . -name "jobService.jar") --workers ./jobService/src/main/resources/WithPostProcessing/inputData/Workers.csv --outputFilePath /var/tmp/schedule/ \
...
travis: compile build geschwisterTag createPdf
